...
!function (e, t, n) {
    ...
    function i(e, t) {
        if ("object" == typeof e) for (var n in e) E(e, n) && i(n, e[n]); else {
            e = e.toLowerCase();
            var r = e.split("."), s = Modernizr[r[0]];
    ...
    function m(e, t, o, i) {
        ...
        for (m = e.length, c = 0; c < m; c++) if (h = e[c], v = L.style[h], u(h, "-") && (h = p(h)), L.style[h] !== n) {
    ...
    var C = [], b = t.documentElement, S = "svg" === b.nodeName.toLowerCase(), _ = "Moz O ms Webkit",
    ...
    Modernizr.addTest("websockets", R), Modernizr.addTest("cssanimations", g("animationName", "a", !0)), function () {
        ...
        var e, t, n, r = s("img"), o = "sizes" in r;
        !o && "srcset" in r ? (t = "data:images/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw==", e = "data:images/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", n = function () {
            i("sizes", 2 === r.width)
